...
public class PesquisarProdutoId extends javax.swing.JFrame {

    private List<Produto> listaProduto;
    private ProdutoDAO pDAO;

    public PesquisarProdutoId() {
        initComponents();
        configuraJanela();
        configuraTabela();
    }
    ...
    private void initComponents() {
        ...
        labelGrandeDeletar.setText("PESQUISA POR IDENTIFICADOR");
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                ...
                .addGroup(jDesktopPane1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jDesktopPane1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(fldId, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (!"".equals(fldId.getText()) && fldId.getText() != null) {
            prod.setId(Integer.parseInt(fldId.getText()));
            preencherTabela(new ProdutoDAO().pesquisaProdutoID(prod, ckbSelecionarPorParte.isSelected()));
        } else {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new PesquisarProdutoId().setVisible(true);
        });
    }
    ...
    private void configuraJanela() {
        ...
        this.setTitle("Pesquisando Produtos por Identificador");
        this.setResizable(false);
        this.setLocationRelativeTo(null);
        this.fldId.setText("");
        this.labelIDSel.setText("Identificador: ");
        this.ckbSelecionarPorParte.setText("Deseja selecionar por parte do ID?");
